...
final class MockedRestaurant {
  ...
  static let TEST_RESTAURANT_VIEW_OBJECT_1 = RestaurantViewObject(business: TEST_BUSINESS_1)
  static let TEST_RESTAURANT_VIEW_OBJECT_2 = RestaurantViewObject(business: TEST_BUSINESS_2)
